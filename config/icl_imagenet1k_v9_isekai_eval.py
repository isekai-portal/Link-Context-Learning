_base_ = ['_base_/dataset/DEFAULT_TEST_BUSINESS.py', '_base_/model/llava_v1_7b.py', '_base_/train/eval.py']
...
data_args = dict(
    ...
    multitest={k: {'cfg': v, 'compute_metric': None} for k, v in _base_.DEFAULT_ISEKAI.items()},
    compute_metric=None,
