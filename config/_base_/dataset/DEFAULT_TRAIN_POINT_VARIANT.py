POINT_TRAIN_COMMON_CFG_LOCAL = dict(
    type='Point_QA_local',
    filename='/mnt/lustre/share_data/chenkeqin/mllm_data/pretrain_data/ann/pointQA_local_train.jsonl',
...
POINT_TRAIN_COMMON_CFG_TWICE = dict(
    type='Point_QA_twice',
    filename='/mnt/lustre/share_data/chenkeqin/mllm_data/pretrain_data/ann/pointQA_twice_train.jsonl',
    image_folder='zz1424:s3://publicdataset_8/Visual_Genome_Dataset_V1.2/unzip/data',
    template_file=r"{{fileDirname}}/template/VQA.json",
)
...
POINT_TRAIN_COMMON_CFG_V7W = dict(
    type='V7W_POINT',
    filename='/mnt/lustre/share_data/chenkeqin/mllm_data/pretrain_data/ann/v7w_pointing_train.jsonl',
