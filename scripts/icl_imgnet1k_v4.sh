sbatch -p atshare_a100_40g  --quotatype=auto \
    ...
    --cfg-options model_args.model_name_or_path='/mnt/lustrenew/share_data/taiyan/shikra/icl_imagenet1k_v4_2shot_binding/checkpoint-4200' \
    ...
    --cfg-options training_args.num_train_epochs=20 \
    --cfg-options training_args.output_dir='/mnt/lustrenew/share_data/taiyan/shikra/icl_imagenet1k_v4_2shot_binding'