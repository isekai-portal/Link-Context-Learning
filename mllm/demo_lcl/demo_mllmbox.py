...
def main(cfg: FairseqConfig):
    ...
    def generate_predictions(image_input, text_input, do_sample, sampling_topp, sampling_temperature):
        ...
        print(f"clean_response_str: {str(clean_response_str)}")
        print(f"response_str: {str(response_str)}" )
        print(f"decode boox: {decode_bbox_from_caption(response_str)}")
    ...
    with gr.Blocks(title="Kosmos-2", theme=gr.themes.Base()).queue() as demo:
        ...
        with gr.Row():
            with gr.Column():
                ...
                text_input = gr.Textbox(placeholder="Description ...",label="Description")
        ...
        with gr.Row():
            with gr.Column():
                gr.Examples(examples=[  
                            ["demo/images/man_ball.png", "<grounding> Describe this image in detail:", False],
                            ["demo/images/man_ball.png", "<grounding> Question: Are there any people in the image, if so, detect them.  Answer:", False],
                            ["demo/images/man_ball.png", "<grounding> Question: Are there any <phrase>people</phrase> in the image, if so, detect them.  Answer:", False],
                            ["demo/images/man_ball.png", "<grounding> Question: <phrase>Are there any people in the image, if so, detect them.</phrase>  Answer:", False],
                            ["demo/images/man_ball.png", "<grounding> Are there any <phrase>people</phrase> in the image? ", False],
                            ["demo/images/man_ball.png", "<grounding> Are there any <phrase>dogs</phrase> in the image? ", False],
                            ["demo/images/man_ball.png", "<grounding> Are there any <phrase>dogs</phrase> in the image? please answer yes or no. Answer: ", False],
                            ["demo/images/man_ball.png", "<grounding> Are there any <phrase>pigs</phrase> in the image? please answer yes or no. Answer: ", False],
                            ["demo/images/two_dogs.jpg", "<grounding> Are there any <phrase>pigs</phrase> in the image? Answer: ", False],
                            ["demo/images/two_dogs.jpg", "<grounding> Are there any <phrase>dogs</phrase> in the image? Answer: ", False],
                        ], inputs=[image_input, text_input, do_sample])
            with gr.Column():
                gr.Examples(examples=[  
                            ["demo/images/icdard.jpg", "<grounding> Describe this image in detail:", False],
                            ["demo/images/icdard.jpg", "<grounding> Question: Are there any id cards in the image, if so, detect them.  Answer:", False],
                            ["demo/images/icdard.jpg", "<grounding> Question: Are there any <phrase>id cards</phrase> in the image, if so, detect them.  Answer:", False],
                            ["demo/images/icdard.jpg", "<grounding> Question: Is anyone playing with a mobile phone? please answer yes or no.  Answer: ", False],
                            ["demo/images/playingphone.jpg", "<grounding> Question: Is <phrase>anyone playing with a mobile phone</phrase>? Answer: ", False],
                            ["demo/images/playingphone.jpg", "<grounding> Question: Is anyone playing with a mobile phone? Answer: ", False],
                            ["demo/images/callingphone.jpg", "<grounding> Question: Is there someone in the picture who is on the phone? Answer: ", False],
                            ["demo/images/callingphone.jpg", "<grounding> Question: Is there anyone in the picture who is holding a mobile phone and making a call? Answer: ", False],
                            ["demo/images/sleeping.jpg", "<grounding> Question: Is anyone <phrase>sleeping</phrase> in the picture? if so, detect them. Answer:", False],
                            ["demo/images/sleeping.jpg", "<grounding> Question: Is anyone sleeping in the picture? Answer:", False],
                        ], inputs=[image_input, text_input, do_sample])
    ...
    server_name = SLURM_ENV.get('SLURM_JOB_NODELIST', None)
    print(server_name)
    demo.launch(server_name=server_name, server_port=12306)
