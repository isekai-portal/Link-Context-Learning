...
MODE=$1
mode_list=("qformer_ICL" "qformer_common" "shikra_ICL" "shikra_common")
if ! [ contains "${MODE}" $mode_list ] then
   echo wrong mode! the mode should be one of the following: ${mode_list}
   exit 1
end
